          ...
          content: (
            <div className='flex flex-col gap-5 overflow-y-auto text-sm text-gray-300'>
              <div className='flex flex-col'>
                <Typography variant='bodySm1' color='gray300' className='h-7.5 leading-7.5'>
                  제1조(목적)
                </Typography>
              ...
              <div className='flex flex-col'>
                ...
                <Typography variant='bodySm2' color='gray300' className='indent-4'>
                  가. 타인의 정보 도용
                </Typography>
                <Typography variant='bodySm2' color='gray300' className='indent-4'>
              ...
              <div className='flex flex-col'>
                ...
                <Typography as='li' variant='bodySm2' color='gray300' className='indent-1'>
              ...
              <div className='flex flex-col'>
                ...
                <Typography variant='bodySm2' color='gray300' className='indent-3'>
                  - 허위 정보 등록, 타인 정보 도용
                </Typography>
                <Typography variant='bodySm2' color='gray300' className='indent-3'>
                  - 법령, 약관, 운영 정책 위반
            ...
            <div className='flex flex-col gap-5 overflow-y-auto text-sm text-gray-300'>
              ...
              <div className='flex flex-col'>
                ...
                <Typography variant='bodySm2' color='gray300' className='indent-1'>
                  ...
                  검색 결과, 추천 영역 등 서비스 내 다른 화면에서 안내 정보로 활용
                </Typography>
                <Typography variant='bodySm2' color='gray300' className='indent-1'>
